...
import { useGetActivityTypes } from "@/services/queries/pipelines";
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subGreeting}>
              Get started on your activities for today!
            </Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          {activityTypesData?.data?.slice(0, 5).map((item: any, i: number) => (
            <TouchableOpacity
              key={i}
              onPress={() => {
